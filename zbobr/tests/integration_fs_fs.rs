...
#[tokio::test]
async fn test_fs_fs_signal_preserved_during_stage() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_signal_preserved_through_transition() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_signal_preserved_with_conflict_flag() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_conflict_flag_cleared_preserves_signal() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_go_review_survives_merge_conflict() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_pause_flag_blocks_processing() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_pause_flag_cleared_allows_processing() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
...
#[tokio::test]
async fn test_fs_fs_stage_can_modify_signal() {
    let _guard = TEST_LOCK.lock().await;
    let Some(env) = get_env().await else { return };
